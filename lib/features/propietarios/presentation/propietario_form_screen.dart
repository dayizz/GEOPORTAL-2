...
import '../data/propietarios_firestore_repository.dart';
...
class _PropietarioFormScreenState extends ConsumerState<PropietarioFormScreen> {
  ...
  Future<void> _loadPropietario() async {
    try {
      final p =
          await ref.read(propietariosFirestoreRepositoryProvider).getPropietarioById(widget.id!);
      if (p != null && mounted) {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final repo = ref.read(propietariosFirestoreRepositoryProvider);
      if (widget.id == null) {
