...
import '../data/estructura_users_firestore_repository.dart';
...
class UserManagementNotifier extends StateNotifier<UserManagementState> {
  ...
  final EstructuraUsersFirestoreRepository _remoteRepository;
...
final userManagementProvider =
  ...
  (ref) => UserManagementNotifier(
    ...
    ref.watch(estructuraUsersFirestoreRepositoryProvider),
  ),
);
