      ...
      floatingActionButton: predioAsync.whenOrNull(
        data: (predio) => predio != null
            ? FloatingActionButton.extended(
                ...
                onPressed: () =>
                    _showActualizarEtapasSheet(context, ref, predio),
              )
            : null,
      ),
            ...
            child: Column(
              ...
              children: [
                        ...
                        children: [
                          Expanded(
                            child: _buildMetricCard(
                              context,
                              Icons.straighten,
                              predio.kmEfectivos != null
                                  ? '${predio.kmEfectivos!.toStringAsFixed(4)} km'
                                  : '-',
                              'Km Efectivos',
                              AppColors.info,
                            ),
                ...
                if (predio.propietario != null ||
                  ...
                  _buildSection(
                    ...
                    [
                      _buildInfoRow(
                        'Nombre',
                        predio.propietario?.nombreCompleto ??
                            predio.propietarioNombre ??
                            '-',
                      ),
                      if (predio.tipoPropiedad == 'SOCIAL' &&
                          predio.ejido != null)
                    ...
                    trailing: predio.propietario != null
                        ? TextButton.icon(
                            ...
                            onPressed: () => context.push(
                              '/propietarios/${predio.propietario!.id}',
                            ),
                          )
                        : null,
                  ),
                ...
                if (predio.latitud != null && predio.longitud != null)
                  _buildSection(context, 'Georreferencia', Icons.place_outlined, [
                    _buildInfoRow(
                      'Coordenadas',
                ...
                // Metadatos
                _buildSection(context, 'Registro', Icons.info_outline, [
                  _buildInfoRow(
                    'Registrado',
          ...
          Container(
            ...
            child: Column(
              children: children.asMap().entries.map((e) {
                ...
                return Column(
                  children: [e.value, if (!isLast) const Divider(height: 1)],
                );
              }).toList(),
            ),
          ),
