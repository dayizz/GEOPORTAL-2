...
class PredioDetailScreen extends ConsumerWidget {
  final String id;
  const PredioDetailScreen({super.key, required this.id});
        ...
        data: (predio) {
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                // Header reorganizado con los campos principales
                Container(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(child: Text(predio.claveCatastral)),
                                  ],
                                ),
                                // 2. Proyecto
                                if (predio.proyecto != null && predio.proyecto!.trim().isNotEmpty) ...[
                                ...
                                // 3. Propietario
                                if (predio.propietarioNombre != null && predio.propietarioNombre!.trim().isNotEmpty) ...[
                                  const SizedBox(height: 2),
                                  Row(
                                    children: [
                                      const Text('Propietario: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                      Expanded(child: Text(predio.propietarioNombre!)),
                                    ],
                                  ),
                                ],
                                ...
                                if (predio.tramo.trim().isNotEmpty) ...[
                                  ...
                                  Row(
                                    children: [
                                      const Text('Tramo: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                ...
                                Row(
                                  children: [
                                    const Text('Km inicio: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                    Text(predio.kmInicio?.toStringAsFixed(3) ?? 'N/D'),
                                    const SizedBox(width: 8),
                                    const Text('Km fin: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                    Text(predio.kmFin?.toStringAsFixed(3) ?? 'N/D'),
                                    const SizedBox(width: 8),
                                    const Text('Km lineal: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                ...
                                Row(
                                  children: [
                                    const Text('Superficie: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                    Text(predio.superficie != null ? '${predio.superficie!.toStringAsFixed(2)} m²' : 'N/D'),
                                  ],
                                ),
                                // 7. Estatus
                                const SizedBox(height: 2),
                                ...
                                Wrap(
                                  ...
                                  runSpacing: 6,
                                  children: [
                                    _buildChip('Identificación', predio.identificacion ? AppColors.secondary : AppColors.textSecondary),
                                    _buildChip('Levantamiento', predio.levantamiento ? AppColors.secondary : AppColors.textSecondary),
                                    _buildChip('Negociación', predio.negociacion ? AppColors.secondary : AppColors.textSecondary),
                                  ],
                                ),
                              ],
                            ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSection(
                        ...
                        Icons.timeline,
                        [
                          _buildEtapaRow('Identificación / Acercamiento', predio.identificacion),
                          _buildEtapaRow('Levantamiento', predio.levantamiento),
                          _buildEtapaRow('Negociación / Asamblea', predio.negociacion),
                          _buildEtapaRow('C.O.P. (Convenio de Ocupación)', predio.cop),
                          _buildEtapaRow('Polígono Insertado en Larguillo', predio.poligonoInsertado),
                        ],
                      ),
          ...
          builder: (ctx, setModalState) {
            void save() {
              ...
              if (isDemo) {
                ...
                ref.read(prediosRepositoryProvider).updatePredio(
                  predio.id,
                  {
                    'identificacion': ident,
                    'levantamiento': levant,
