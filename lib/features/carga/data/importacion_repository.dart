...
final importacionRepositoryProvider = Provider<ImportacionRepository>((ref) {
  return ImportacionRepository(
    prediosRepository: ref.read(prediosFirestoreRepositoryProvider),
    propietariosRepository: ref.read(propietariosFirestoreRepositoryProvider),
  );
});
...
class ImportacionRepository {
  final PrediosFirestoreRepository _prediosRepository;
  final PropietariosFirestoreRepository _propietariosRepository;

  const ImportacionRepository({
    required PrediosFirestoreRepository prediosRepository,
    required PropietariosFirestoreRepository propietariosRepository,
