...
class SincronizacionService {
  final PrediosFirestoreRepository _prediosRepo;
  final PropietariosFirestoreRepository _propietariosRepo;
  ...
  Map<String, dynamic> _injectData(
    ...
    enriched['_estructura'] = predioMap['estructura'];
    enriched['_cop'] = cop;
    enriched['cop'] = cop;
  ...
  String? _pick(Map<String, dynamic> props, List<String> keys) {
    dynamic pickRaw() {
      ...
      for (final entry in props.entries) {
        ...
        normalizedLookup.putIfAbsent(norm, () => entry.value);
      }

      for (final k in keys) {
        final normKey = _normalizeKey(k);
        final value = normalizedLookup[normKey];
  ...
  dynamic _pickDynamic(Map<String, dynamic> props, List<String> keys) {
    for (final k in keys) {
      if (props.containsKey(k)) {
        final value = props[k];
        final text = value?.toString().trim();
    ...
    for (final k in keys) {
      final value = normalizedLookup[_normalizeKey(k)];
      final text = value?.toString().trim();
      if (text != null && text.isNotEmpty && text != 'null') {
        return value;
      }
  ...
  bool? _pickBool(Map<String, dynamic> props, List<String> keys) {
    return _toBoolNullable(_pickDynamic(props, keys));
  }

  String? _normalizeStatusLabel(Map<String, dynamic> props) {
    final raw = _pickDynamic(props, [
      'estatus_predio',
      'estatus',
      'estado_predio',
      'ESTATUS_PREDIO',
    ...
    return GeoJsonMapper.normalizeEstatusNullable(raw);
  }

  String? _pickObservaciones(Map<String, dynamic> props) {
    return _pick(props, [
  ...
  Map<String, dynamic> _buildNuevoPredioData(
    ...
    final observaciones = _pickObservaciones(props);
    ...
    final data = <String, dynamic>{
      ...
      'estructura': _pick(props, [
        'estructura', 'ESTRUCTURA',
        'estructura_vial', 'ESTRUCTURA_VIAL',
        'estructura_tipo', 'tipo_estructura',
      ]),
    ...
    if (observaciones != null) {
      data['situacion_social'] = observaciones;
    }
  ...
  Map<String, dynamic> _buildGestionUpdateData(
    ...
    if (observaciones != null) {
      updates['situacion_social'] = observaciones;
    }
      ...
      if (clave != null) {
        ...
        if (predioByClaveCache.containsKey(claveNormalizada)) {
          ...
          existente = await _withRetry(
            () async {
              final predio = await _prediosRepo.buscarPorClaveCatastral(claveNormalizada);
              return predio != null ? predio.toMap() : null;
            },
...
final sincronizacionServiceProvider = Provider<SincronizacionService>((ref) {
  return SincronizacionService(
    ref.read(prediosFirestoreRepositoryProvider),
    ref.read(propietariosFirestoreRepositoryProvider),
  );
});
